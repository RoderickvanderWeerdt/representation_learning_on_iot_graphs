...
def pipeline4(graph_c, entities_c, create_emb=True, show_all=True, embs_or_feats=1, use_all=False, target_class="hot_cold_target", entities_column="timestamp_uri"):
    ...
    if create_emb:
        make_embeddings(entities_fn=entities_c, 
                        ...
                        entities_column_name=entities_column,reverse=True,
    ...
    final_results = perform_prediction(dataset_fn=entities_emb, show_all=show_all, save_model=True, embeddings_or_features=embs_or_feats, use_all=use_all, target_class=target_class)
...
def main(graph_name, entities_file, target_class, entities_column):
    epochs = 20
    walkLength = 2
    nWalks = 25
    reverse = True
    ...
    pipeline4(graph_name, entities_file, create_emb=True, show_all=False, embs_or_feats=1, use_all=False, target_class=target_class, entities_column=entities_column)
    for i in range(2):
        pipeline4(graph_name, entities_file, create_emb=False, show_all=False, embs_or_feats=1, use_all=False, target_class=target_class, entities_column=entities_column)
...
if __name__ == '__main__':
    ...
    # graph_name = "res1dev1CO2_graph_111.ttl"
    # # graph_name = "res1dev1CO2_graph_001.ttl"
    # entities_file = "entityfile_res1dev1CO2.csv"

    # graph_name = "res1devA_graph_111.ttl"
    # # # graph_name = "res1devA_graph_001.ttl"
    # # entities_file = "entityfile_res1devA.csv"
    ...
    if OfficeGraph:
        ...
        graph_name = "pecan/graphs/res1devA_enriched.nt"
        entities_file = "pecan/pecan_entities.csv"
        target_class = "https://interconnectproject.eu/example/Konstanz_HotCold"
        entities_column = "timestamp"


    main(graph_name, entities_file, target_class, entities_column)
